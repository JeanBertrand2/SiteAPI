...
export const useFetchIntervenantById = () =>
...
export const useCreateIntervenant = () =>
  useCallback(async (intervenantData) => {
    try {
      const response = await fetch(`${API_URL}/intervenants/`, {
        method: "POST",
        headers: {
...
export const useUpdateIntervenant = () =>
  useCallback(async (id, intervenantData) => {
    try {
      const response = await fetch(`${API_URL}/intervenants/${id}`, {
        method: "PUT",
        headers: {
...
export const useDeleteIntervenant = () =>
  useCallback(async (id) => {
    try {
      if (!id) throw new Error("ID intervenant manquant");
      const response = await fetch(`${API_URL}/intervenants/${id}`, {
